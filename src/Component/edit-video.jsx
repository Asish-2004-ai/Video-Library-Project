...
export function Editvideo() {
  ...
  function Loadvideo() {
    axios
      .get(`https://video-library-project.vercel.app/get-videos/${param.id}`)
      .then((res) => {
        setvideos(res.data);
      });
  }
  ...
  function Loadcategories() {
    axios.get("https://video-library-project.vercel.app/get-categories").then((response) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (video) => {
      axios.put(`https://video-library-project.vercel.app/edit-video/${video.VideoId}`, video).then(() => {
        alert("Video updated");
