...
export function Editvideo() {
  ...
  function Loadvideo() {
    axios
      .get(`http://127.0.0.1:3030/get-videos/${param.id}`)
      .then((res) => {
        setvideos(res.data);
      });
  }
  ...
  function Loadcategories() {
    axios.get("http://127.0.0.1:3030/get-categories").then((response) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (video) => {
      axios.put(`http://127.0.0.1:3030/edit-video/${video.VideoId}`, video).then(() => {
        alert("Video updated");
